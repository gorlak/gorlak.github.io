...
= Day 1 August 5th, 2016 =

== 10am Intro to Day 1 ==
* Intro from Ryan Schneider, wifi password is ITC-Guest/faceface11.  OMG its WEP encryption; nobody is safe.
...
Adnreas: No file i/o in the game, only request load of asset-id, not file
...
== 3:00pm Interview w/ Abdul Bezrati ==
